...
class Unet(nn.Module):
    ...
    def __init__(
        ...
        # Output projection. Historically this was a 1x1 conv; we use 5x5 to match
        # the PromptMRUNet backbone when doing ablations/comparisons.
        self.conv1d = nn.Conv2d(chans, out_chan, kernel_size=5, padding=2, bias=False)
        self.depth = depth
