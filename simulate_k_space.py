...
def process_file(file, out_path, seed, noise, coil_file, num_coils):
    ...
    # Normalize each contrast safely (some slices can be all-zeros)
    denom = np.nanmax(np.abs(images), axis=(1, 2), keepdims=True)
...
if __name__ == '__main__':
    ...
    dir = '/home/anvariha/projects/def-mchiew/kadotab/Datasets/Brats_2021/brats/training_data/subset'
    save_dir = str(sys.argv[1])
    coil_file = str(sys.argv[2])
...
#python simulate_k_space.py /home/anvariha/projects/def-mchiew/kadotab/Datasets/Brats_2021/brats/training_data/subset /home/anvariha/projects/def-bmac/sim_subset_no_noise coil_compressed_10_240x240.npy 0